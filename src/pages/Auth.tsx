              ...
              <Button
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-[#2d2d44] px-3 text-gray-500 uppercase tracking-wider">or</span>
                  </div>
                </div>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-11 sm:h-12 bg-white/5 border-white/10 text-white hover:bg-white/10 font-medium gap-3 text-sm sm:text-base"
